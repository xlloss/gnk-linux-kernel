...
static const struct {
	...
	.common = {
		...
		DEF_MUX(".sel_pll5_4", CLK_SEL_PLL5_4, SEL_PLL5_4,
			sel_pll5_4, ARRAY_SIZE(sel_pll5_4), 0, CLK_MUX_HIWORD_MASK),
...
static const struct {
	...
	.common = {
		...
		DEF_MOD("mtu_x_mck",	R9A07G044_MTU_X_MCK_MTU3, R9A07G044_CLK_P0,
					0x538, 0),
		DEF_MOD("ostm0",	R9A07G044_OSTM0_PCLK, R9A07G044_CLK_P0,
					0x534, 0),
		DEF_MOD("ostm1",	R9A07G044_OSTM1_PCLK, R9A07G044_CLK_P0,
					0x534, 1),
		DEF_MOD("ostm2",	R9A07G044_OSTM2_PCLK, R9A07G044_CLK_P0,
					0x534, 2),
